...
title: TailnetWind template in depth
excerpt: While easy to get started, TailnetWind is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://tailnet-wind.vercel.app/astrowind-template-in-depth
---
